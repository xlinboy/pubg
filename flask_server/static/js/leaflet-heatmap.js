    ...
    var HeatmapOverlay = L.Layer.extend({
        ...
        _update: function () {
            ...
            while (len--) {
                ...
                // var pointx = this._map.latLngToContainerPoint(latlng);
                // var pointy = this._map.latLngToContainerPoint({lat:latlng.lng,lng:latlng.lat});
                // var latlngPoint = {x: Math.round(pointx.x), y: Math.round(pointy.x)};
                var latlngPoint = {x: Math.round(point.x), y: Math.round(point.y)};
                // var latlngPoint = {x: latlng.lng, y: latlng.lat};
