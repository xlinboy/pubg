    ...
    var me, fe, ge, ve = (Object.freeze || Object)({
        ...
        Pe = (Object.freeze || Object)({
            ...
            project: function (t, i) {
                // console.log("A:"+t)
                // console.log("B:"+this.options.crs.latLngToPoint(C(t), i))
            ...
            latLngToLayerPoint: function (t) {
                // console.log(this.project(C(t))._round()._subtract(this.getPixelOrigin()))
                // console.log("A:"+this.project(C(t)))
                // console.log(this.getPixelOrigin())
                // console.log(this.project(C(t))._round()._subtract(this.getPixelOrigin()))
            ...
            latLngToContainerPoint: function (t) {
                // console.log(t)
                // console.log("C:"+C(t))
                // console.log(this.latLngToLayerPoint(C(t)))
                // console.log(this.layerPointToContainerPoint(this.latLngToLayerPoint(C(t))))
